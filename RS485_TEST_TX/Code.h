...
struct
{
  ...
  u16 DATA[12];                                //Область DATA
}UR= 
{
  0xAA, 0xFF, 0x00, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
};
/**************************************************************************************************/
typedef struct
{
...
#define SET_NULL_ADDR_CMD       1
#define GET_NULL_ADDR_CMD       2
#define SET_NEW_ADDR_CMD        3
#define GET_NEW_ADDR_CMD        4
